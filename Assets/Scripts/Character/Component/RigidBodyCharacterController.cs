...
namespace Character.Component
{
    ...
    public class RigidBodyCharacterController : MonoBehaviour
    {
        ...
        {
            resultMovementVelocity = _rigidbody.transform.right * Input.GetAxis("Horizontal") + _rigidbody.transform.forward * Input.GetAxis("Vertical");
            resultRotationAngle = new Vector3(Input.GetAxis("Mouse X"), Input.GetAxis("Mouse Y"), 0);
        }
    }
}